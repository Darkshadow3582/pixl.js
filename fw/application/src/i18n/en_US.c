...
const char * const lang_en_US[_L_COUNT] = {
    ...
    [_L_APP_SET_DISPLAY_ORIENTATION] = "Display orientation",
    [_L_APP_SET_LANDSCAPE] = "Landscape",
    [_L_APP_SET_LANDSCAPE_FLIPPED] = "Landscape (180deg)",
    [_L_APP_SET_CONTROLS_SWAP_LEFT_RIGHT] = "Swap Left/Right Controls (L/R)",
