...
const char * const lang_ja_JP[_L_COUNT] = {
    ...
    [_L_APP_SET_RESET_DEFAULT_CONFIRM] = "設定のリセットを確認しますか？",
    [_L_APP_SET_ABOUT] = "デバイスについて",
    [_L_APP_SET_ABOUT_OPEN_SOURCE_PROJECT] = "オープンソースプロジェクト",
    ...
    [_L_APP_AMIIDB_MORE_MESSAGE] = "検索結果が多すぎます。検索条件を絞り込んでください。",
    ...
    [_L_APP_AMIIDB_NOT_SUPPORT_V3] = "amiibo v3\nはサポートされていません",
    ...
    [_L_APP_CHAMELEON_CARD_ADV_LOAD_BLOCK0] = "Block0から読み込み中...",
    [_L_APP_CHAMELEON_CARD_ADV_LOAD_BLOCK0_SUCCESS] = "Block0の読み込みに成功しました",
    [_L_APP_CHAMELEON_CARD_ID_SIZE] = "ID サイズ",
