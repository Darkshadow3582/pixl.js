...
const char * const lang_es_ES[_L_COUNT] = {
    ...
    [_L_APP_SET_DISPLAY_ORIENTATION] = "Orientación de pantalla",
    [_L_APP_SET_LANDSCAPE] = "Horizontal",
    [_L_APP_SET_LANDSCAPE_FLIPPED] = "Horizontal (180deg)",
    [_L_APP_SET_CONTROLS_SWAP_LEFT_RIGHT] = "Intercambiar controles izquierda/derecha (I/D)",
