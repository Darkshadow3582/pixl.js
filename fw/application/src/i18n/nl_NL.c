...
const char * const lang_nl_NL[_L_COUNT] = {
    ...
    [_L_APP_SET_DISPLAY_ORIENTATION] = "Schermorientatie",
    [_L_APP_SET_LANDSCAPE] = "Liggend",
    [_L_APP_SET_LANDSCAPE_FLIPPED] = "Liggend (180deg)",
    [_L_APP_SET_CONTROLS_SWAP_LEFT_RIGHT] = "Bediening links/rechts wisselen (L/R)",
